...
def ejecutar_escaneo_cli(
    host, puertos="1-1000", scripts="default", output_format="detailed"
):
    """
...
Ejemplos de uso:
  ...
  %(prog)s --show 1                          # Mostrar reporte #1
    ...
    parser.add_argument("-t", "--target", help="Host objetivo a escanear")

    parser.add_argument(
        "-p", "--ports", default="1-1000", help="Puertos a escanear (default: 1-1000)"
    )
    ...
    parser.add_argument(
        "--list", action="store_true", help="Listar reportes disponibles"
    )

    parser.add_argument(
        "--show", type=int, metavar="N", help="Mostrar contenido del reporte número N"
    )
